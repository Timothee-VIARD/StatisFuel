...
class _ConsumptionFormState extends State<ConsumptionForm> {
  ...
  Widget build(BuildContext buildContext) {
    return BlocProvider(
      ...
      )..initializeWithConsumption(
          widget.consumption ?? Consumption(date: DateTime.now()),
        ),
      child: Builder(
            ...
            children: [
              ...
              Selector<DateTime?>(
                ...
                builder: (context, date) => TextFormField(
                  ...
                  //     return t.global.forms.required;w
                  //   }
                  //   return null;
                  // },
                  onTap: () async {
              ...
              Selector<Location?>(
                selector: (state) => state.consumption.location,
                builder: (context, field) => LocationField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    labelText: t.consumption.place.label,
                    border: const OutlineInputBorder(),
                  ),
                ),
              ),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (isValid) {
                          final cubit = context.read<NewConsumptionCubit>();
                          widget.onSave(
                            cubit.state.consumption,
